...
export default function UpcomingExams() {
  ...
  // When course changes → extract semesters from course object
  useEffect(() => {
    if (!courseId) {
      setSemesters([]);
      setSemester("");
  ...
  // When both course + semester selected → fetch subjects automatically
  useEffect(() => {
  ...
  // SUBJECTS SEEDHA COURSE OBJECT SE NIKALO — same as Result.jsx
  const fetchSubjects = () => {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 mb-10 shadow-sm">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-semibold">Create Exam Timetable</h2>
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {!courseId && (
                <p className="text-xs text-slate-400 mt-0.5">
                  Select a course to load semesters
                </p>
              )}
            </div>
          </div>
            ...
            <>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-7 py-2.5 rounded-xl transition shadow-sm shadow-indigo-200"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
