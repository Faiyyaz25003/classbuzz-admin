...
function UploadSection({ onSuccess }) {
  ...
  const handleUpload = async () => {
    if (
      ...
      setError("All fields and PDF are required");
      return;
    }
    setError("");
    setUploading(true);
        ...
        <div style={{ flex: "1 1 280px" }}>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 12,
              background: dragging ? "#eef2ff" : file ? "#f0fdf4" : "#fafbff",
              padding: "14px 18px",
              display: "flex",
              alignItems: "center",
              gap: 12,
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              {/* Show subject as primary, book name as subtitle */}
        ...
        >
          ...
          <div>
            ...
            {/* Show subject as primary in the book field */}
            <div
              style={{
                background: `${col}10`,
            ...
            >
              ...
              {book.subject && (
                <span
                  style={{ fontSize: 11, color: `${col}99`, marginLeft: 8 }}
                >
                  ({book.name})
                </span>
              )}
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              {/* Subject as primary title in PDF viewer */}
...
function BookCard({ book, onClick, onDelete }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {onDelete && (
          <button
            onClick={(e) => {
              e.stopPropagation();
              if (confirm("Delete this book?")) onDelete(book._id);
            }}
            style={{
              width: 26,
              height: 26,
      ...
      {/* ✅ CHANGED: Book name shown below, course shown alongside */}
      <div style={{ fontSize: 11, color: "#94a3b8" }}>
        {book.name}
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 32,
                          borderRadius: 8,
                          background: b.bg || "#eef2ff",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          fontSize: 15,
                          border: `1px solid ${b.color || "#6366f1"}22`,
                          flexShrink: 0,
                        }}
                      >
                        📚
                      ...
                      <div>
                        {/* ✅ CHANGED: Show subject as primary, bookName as secondary */}
                        <div
                          style={{
                            fontWeight: 600,
                            color: "#0f172a",
    ...
    >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: "#94a3b8", fontSize: 13 }}>
              Manage and track educational resources
            </p>
          </div>
        </div>
        <div
      ...
      {active && (
        <div>
          ...
          >
            ...
            <div>
              ...
              <div style={{ color: "#94a3b8", fontSize: 12 }}>
                {active === "all" ? allBooks.length : issuedBooks.length}{" "}
          ...
          {active === "issued" && (
            ...
            >
              {[
                ...
                >
                  <span style={{ fontSize: 20, fontWeight: 800, color: s.col }}>
                    {s.val}
                  </span>
                  <span style={{ fontSize: 12, color: s.col, fontWeight: 600 }}>
                    {s.label}
                  </span>
                </div>
              ))}
          ...
          <div
            style={{ position: "relative", maxWidth: 380, marginBottom: 22 }}
          >
            <span
              style={{
                position: "absolute",
