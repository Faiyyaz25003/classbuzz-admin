...
//         paymentName: "",
//       });
//       setShowForm(false); // 👈 Form submit hone ke baad close ho jayega
//     } catch (error) {
...
//         {/* 👇 Open Form Toggle Button */}
//         <button
//           onClick={() => setShowForm((prev) => !prev)}
//           className={`ml-auto px-5 py-2 rounded-full text-sm font-semibold transition-all duration-200 shadow-sm flex items-center gap-2 ${
//             showForm
//               ? "bg-red-500 text-white hover:bg-red-600 shadow-red-200 shadow-md"
...
//       {/* Form - Toggle hoga */}
//       {showForm && (
//         <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100 transition-all duration-300">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 bg-red-500 hover:bg-red-600 text-white text-xs font-semibold px-4 py-2 rounded-lg transition-all duration-150 shadow-sm disabled:opacity-60"
                        >
