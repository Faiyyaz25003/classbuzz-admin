...
import React, { useEffect, useState } from "react";
import { Calendar, Clock, BookOpen, Sparkles, Zap, Layers } from "lucide-react";
...
export default function Schedule() {
  ...
  const getSubjectColor = (subjectName, timetableSubjects) => {
    ...
    return subjectColors[index % subjectColors.length] + " text-white";
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-4">
          <div className="p-4 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 shadow-lg">
          ...
          <div>
            ...
            <p className="text-gray-500">
              Generate AI styled academic timetable instantly
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <select
                ...
                onChange={(e) => setSelectedSemester(e.target.value)}
                disabled={!selectedCourse}
                className="w-full border rounded-xl px-4 py-3 focus:ring-2 focus:ring-purple-400"
              >
            ...
            <div className="flex items-end">
              <button
                onClick={generateTimetable}
                disabled={isGenerating}
                className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl py-3 font-semibold flex items-center justify-center gap-2 hover:scale-105 transition"
              >
                <Zap size={18} />
        ...
        {Object.keys(timetables).length > 0 ? (
          ...
          <div className="bg-white rounded-3xl shadow-xl p-16 text-center">
            <Calendar className="mx-auto mb-4 text-indigo-500" size={40} />
